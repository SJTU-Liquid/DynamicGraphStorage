...
struct sequence_ops : Tree {
  ...
  // usefull if using 20th century constructs such as node_iterators
  template<typename F>
  ...
  static node_iterator node_begin(node * root) {
    return node_iterator(root);
  }

  static node_iterator node_end() {
